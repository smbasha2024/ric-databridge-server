...
class DataBridgeRepo:
    ...
    async def getComplianceItemsForAutoClosure(self,tenant_id: str, app_id: str, activity_items: List[RegPortalEvidenceDTO]) -> List[RegPortalEvidenceDTO]:
        ...
        Expected input dict keys:
            ...
            - RicagoSecionID (maps to riago_section_id)
        ...
        for item in activity_items:
            cond = and_(
                ...
                RegPortalEvidenceModel.riago_section_id == item.riago_section_id,
            )
    ...
    async def getDocumentsForID(self, tenant_id: str, app_id: str, doc_id: str, tenant_name: str, tenant_url: str):
